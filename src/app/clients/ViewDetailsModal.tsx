                  ...
                  {client.banks.map(bank => (
                    <TableRow key={bank.id} className="border-gray-800 hover:bg-gray-800/50">
                      ...
                      <TableCell className="text-red-400 flex items-center">
                        ...
                        {bank.loanAmount}
                        {bank.settled && (
                          <span className="ml-2 inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 border border-green-200 dark:border-green-800">
                            Settled
                          </span>
                        )}
                      </TableCell>
