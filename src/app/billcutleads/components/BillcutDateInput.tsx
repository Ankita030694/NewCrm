  ...
  ({ value, onClick, placeholder, onClear }, ref) => (
    <div className="relative">
      <input
        ...
        readOnly
        className="block w-full pl-3 pr-10 py-2 text-sm border border-gray-600/50 bg-gray-700/50 text-gray-200 focus:outline-none focus:ring-blue-500 focus:border-blue-400 rounded-lg cursor-pointer hover:border-blue-400/50 transition-colors"
      />
