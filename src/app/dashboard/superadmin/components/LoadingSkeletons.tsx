...
export const MetricCardSkeleton: React.FC = () => (
  <div className="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 rounded-lg overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col h-full animate-pulse transition-colors">
...
export const ChartSkeleton: React.FC<{ height?: string }> = ({ height = "h-48" }) => (
  <div className={`${height} bg-gray-100 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 animate-pulse flex items-center justify-center transition-colors`}>
    <div className="text-gray-400 dark:text-gray-500 text-sm">Loading chart...</div>
  </div>
);

export const TableSkeleton: React.FC = () => (
  <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 mb-4 animate-pulse transition-colors">
        ...
        {[...Array(4)].map((_, rowIndex) => (
          <tr key={rowIndex} className="bg-white dark:bg-gray-800/40">
            {[...Array(6)].map((_, colIndex) => (
              <td key={colIndex} className="p-2 border-t border-gray-200 dark:border-gray-700">
...
export const DashboardSkeleton: React.FC = () => (
  <div className="p-2 min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white transition-colors">
    <div className="h-6 bg-gray-300 dark:bg-gray-700 rounded w-64 mb-4 animate-pulse"></div>
